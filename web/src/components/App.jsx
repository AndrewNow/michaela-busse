...
import { blobData } from "./blob_data.js"

// Importing components here;
import Shape from './Shape.jsx'
import ProjectTemplate from './ProjectsTemplates/ProjectTemplate.jsx';
import ProjectHeadline from './ProjectsHeadline/ProjectHeadline.jsx';
import NewsParent from './NewsTemplate/NewsParent.jsx';
...
function App({blogData, newsData, generalInfoData, categoryData}) {
  ...
  let backgroundGreyColor = "black"
    ...
    let renderSortingMenu = () => {
      ...
      .map((ele, index) => {
        return (
          <div className='sorting_menu_cells' index={index} key={index}>
            <div>
